...
if train_cell_idx != -1:
    ...
    # We write new_source as a list containing a single string to avoid newline splitting issues!
    nb['cells'][train_cell_idx]['source'] = ["".join(new_source)]
...
if init_cell_idx != -1:
    ...
    if "netD =" not in source_str:
        ...
        nb['cells'][init_cell_idx]['source'] = [source_str]
